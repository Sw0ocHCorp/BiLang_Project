 ...
 * </p>
 * <ul>
 *   <li>{@link ucal3ia.BiLang.impl.FileExtractorImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FileExtractorImpl extends NamedElementImpl implements FileExtractor {
	...
	protected EClass eStaticClass() {
		return BiLangPackage.Literals.FILE_EXTRACTOR;
	}
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BiLangPackage.FILE_EXTRACTOR__PATH, oldPath, path));
	}
