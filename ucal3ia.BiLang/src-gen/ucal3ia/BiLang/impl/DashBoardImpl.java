 ...
 * </p>
 * <ul>
 *   <li>{@link ucal3ia.BiLang.impl.DashBoardImpl#getFileextractor <em>Fileextractor</em>}</li>
 *   <li>{@link ucal3ia.BiLang.impl.DashBoardImpl#getDatafiltering <em>Datafiltering</em>}</li>
 *   <li>{@link ucal3ia.BiLang.impl.DashBoardImpl#getPlot <em>Plot</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DashBoardImpl extends NamedElementImpl implements DashBoard {
	...
	protected EClass eStaticClass() {
		return BiLangPackage.Literals.DASH_BOARD;
	}
		...
		if (fileextractor != null && fileextractor.eIsProxy()) {
			...
			if (fileextractor != oldFileextractor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BiLangPackage.DASH_BOARD__FILEEXTRACTOR,
	...
	public void setFileextractor(FileExtractor newFileextractor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BiLangPackage.DASH_BOARD__FILEEXTRACTOR,
					oldFileextractor, fileextractor));
	}
	...
	public DataFiltering getDatafiltering() {
		if (datafiltering != null && datafiltering.eIsProxy()) {
			...
			if (datafiltering != oldDatafiltering) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BiLangPackage.DASH_BOARD__DATAFILTERING,
	...
	public void setDatafiltering(DataFiltering newDatafiltering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BiLangPackage.DASH_BOARD__DATAFILTERING,
					oldDatafiltering, datafiltering));
	}
	...
	public EList<Plot> getPlot() {
		if (plot == null) {
			plot = new EObjectContainmentEList<Plot>(Plot.class, this, BiLangPackage.DASH_BOARD__PLOT);
		}
		return plot;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case BiLangPackage.DASH_BOARD__FILEEXTRACTOR:
			if (resolve)
				return getFileextractor();
			return basicGetFileextractor();
		case BiLangPackage.DASH_BOARD__DATAFILTERING:
			if (resolve)
