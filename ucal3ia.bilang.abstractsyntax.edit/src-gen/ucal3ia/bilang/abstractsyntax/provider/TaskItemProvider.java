...
/**
 * This is the item provider adapter for a {@link ucal3ia.bilang.abstractsyntax.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AbstractsyntaxPackage.Literals.TASK__FILEEXTRACTOR);
			childrenFeatures.add(AbstractsyntaxPackage.Literals.TASK__DATAFILTERING);
			childrenFeatures.add(AbstractsyntaxPackage.Literals.TASK__DASHBOARD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(AbstractsyntaxPackage.Literals.TASK__FILEEXTRACTOR,
				AbstractsyntaxFactory.eINSTANCE.createExcelExtractor()));

		newChildDescriptors.add(createChildParameter(AbstractsyntaxPackage.Literals.TASK__DATAFILTERING,
				AbstractsyntaxFactory.eINSTANCE.createDataFiltering()));

		newChildDescriptors.add(createChildParameter(AbstractsyntaxPackage.Literals.TASK__DASHBOARD,
				AbstractsyntaxFactory.eINSTANCE.createDashBoard()));
	}
