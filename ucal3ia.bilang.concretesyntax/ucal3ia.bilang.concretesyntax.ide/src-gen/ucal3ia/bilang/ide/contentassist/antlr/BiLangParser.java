...
public class BiLangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BiLangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTaskAccess().getDatafilteringAssignment_5_2(), "rule__Task__DatafilteringAssignment_5_2");
			...
			builder.put(grammarAccess.getTaskAccess().getDatafilteringAssignment_6_1_2(), "rule__Task__DatafilteringAssignment_6_1_2");
