...
public class BiLangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BiLangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCsvExtractorAccess().getGroup_5(), "rule__CsvExtractor__Group_5__0");
			builder.put(grammarAccess.getCsvExtractorAccess().getGroup_5_2(), "rule__CsvExtractor__Group_5_2__0");
			builder.put(grammarAccess.getExcelExtractorAccess().getGroup(), "rule__ExcelExtractor__Group__0");
			builder.put(grammarAccess.getExcelExtractorAccess().getGroup_5(), "rule__ExcelExtractor__Group_5__0");
			builder.put(grammarAccess.getExcelExtractorAccess().getGroup_5_2(), "rule__ExcelExtractor__Group_5_2__0");
			...
			builder.put(grammarAccess.getDashBoardAccess().getFileextractorAssignment_2(), "rule__DashBoard__FileextractorAssignment_2");
			...
			builder.put(grammarAccess.getCsvExtractorAccess().getNullreplacementAssignment_5_1(), "rule__CsvExtractor__NullreplacementAssignment_5_1");
			builder.put(grammarAccess.getCsvExtractorAccess().getNullreplacementAssignment_5_2_1(), "rule__CsvExtractor__NullreplacementAssignment_5_2_1");
			...
			builder.put(grammarAccess.getExcelExtractorAccess().getNullreplacementAssignment_5_1(), "rule__ExcelExtractor__NullreplacementAssignment_5_1");
			builder.put(grammarAccess.getExcelExtractorAccess().getNullreplacementAssignment_5_2_1(), "rule__ExcelExtractor__NullreplacementAssignment_5_2_1");
